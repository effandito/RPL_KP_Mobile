...
class VerifPkp extends StatefulWidget {
  final String title;
  Pkp p = new Pkp();
  VerifPkp({Key key, @required this.title,this.p}) : super(key: key);

  @override
  _VerifPkpState createState() => _VerifPkpState(title,p);
}

class _VerifPkpState extends State<VerifPkp> {
  final GlobalKey<FormState> _formState = GlobalKey<FormState>();
  final String title;
 Pkp p = new Pkp();


  _VerifPkpState(this.title,this.p);
